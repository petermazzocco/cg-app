              ...
              <form className="space-y-8">
                ...
                <div>
                  <div className="flex items-center space-x-5">
                    ...
                    <div className="relative">
                      ...
                      >
                        Start At{" "}
                        <span className="text-xs font-thin">[30 days max]</span>
                      </label>
                      <input
                        type="text"
                        id="startAt"
                ...
                <div className="w-1/3">
                  ...
                  <p className="text-xs font-thin pt-2">
                    * Creating a campaign incurs gas fees to deploy and set the
                    smart contract. Please have enough ETH in your wallet before
                    submitting your campaign to cover these gas fees.
                  </p>
                </div>
              </form>
            </motion.div>
