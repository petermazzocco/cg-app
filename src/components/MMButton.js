  ...
  return (
    <div className="grid justify-center pt-5 space-y-4">
      <motion.button
        ...
        className="text-white bg-[#F6851B] hover:text-gray-800 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 mr-2 mb-2"
      >
        <svg
          aria-hidden="true"
